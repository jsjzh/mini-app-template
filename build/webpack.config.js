...
function assetsPath(_path) {
  const assetsSubDirectory = isProduction ? config.dev.assetsSubDirectory : config.build.assetsSubDirectory
  // 获取相对目录常用 用于拼接
...
const webpackConfig = {
  ...
  module: {
    rules: [{
      ...
      loader: "vue-loader",
      // options: {
      //   transformAssetUrls: { video: ["src", "poster"], source: "src", img: "src", image: "xlink:href" },
